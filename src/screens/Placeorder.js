...
const Placeorder = ({ navigation, route }) => {
  ...
  const placenow = () => {
    if (userdata.address == "") {
      Alert.alert(
        "Số bàn đang trống",
        "Vui lòng nhập số bàn bạn đang ngồi hiện tại",
        [
          {
            text: "Add table",
      ...
      Alert.alert(
        ...
        "Chúng tôi đã nhận được đơn hàng của bạn. Xin vui lòng chờ thức uống"
      );
  ...
  return (
    <ScrollView style={styles.containerout}>
      ...
      <View style={styles.container}>
        <Text style={styles.head1}>Tổng đơn hàng của bạn</Text>
                  ...
                  <View style={styles.row}>
                    <View style={styles.left}>
                      ...
                      <Text style={styles.price1}>
                        {formatcurr(item.data.foodPrice)} VNĐ
                      </Text>
                    </View>
                  </View>
                </View>
        ...
        <View style={styles.row}>
          ...
          <View style={styles.left}>
            <Text style={styles.totalprice}>{formatcurr(totalCost)} VNĐ</Text>
          </View>
        </View>
        ...
        <View style={styles.userdataout}>
          <Text style={styles.head1}>Thông tin khách hàng</Text>
          <View style={styles.row}>
            <View style={styles.left}>
          ...
          <View style={styles.row}>
            <View style={styles.left}>
              <Text style={styles.title}>Số bàn :</Text>
            </View>
            <View style={styles.right}>
